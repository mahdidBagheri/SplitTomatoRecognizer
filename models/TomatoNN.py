...
class TomatoNN(nn.Module):
    def __init__(self):
        ...
        self.conv4 = self.conv_block(n=1, nIn=128, nOut=256)
        self.conv5 = self.conv_block(n=1, nIn=256, nOut=512)
        self.pool6 = nn.MaxPool2d(kernel_size=(3, 3))

        self.conv7 = self.conv_block(n=1, nIn=512, nOut=1024)
        self.conv8 = self.conv_block(n=1, nIn=1024, nOut=2048)
        ...
        self.dense1 = self.dense_block(2, nIn=2048*7*7, nOut=1024)
